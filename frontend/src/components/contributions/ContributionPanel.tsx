...
function ModalShell({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4 pt-[max(1rem,var(--top-header-h))] pb-[max(1rem,calc(env(safe-area-inset-bottom)+var(--bottom-nav-h)))]"

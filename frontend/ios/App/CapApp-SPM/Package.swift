...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorBackgroundGeolocationFrontline", path: "../../../packages/capacitor-background-geolocation-frontline"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "CapacitorBackgroundGeolocationFrontline", package: "CapacitorBackgroundGeolocationFrontline"),
